import { useProfile, useSkills, useExperience, useProjects } from "@/hooks/use-portfolio";
...
import { Loader2, Linkedin, Mail, MapPin, Github, ArrowDown } from "lucide-react";
...
export default function Home() {
  ...
  const isLoading = isProfileLoading || isSkillsLoading || isExpLoading || isProjectsLoading;
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      {/* HERO SECTION */}
      <section id="about" className="relative min-h-screen flex items-center justify-center pt-20 pb-16 overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold tracking-tight text-foreground">
                Hi, I'm <br />
                <span className="text-primary">{profile?.name || "Developer"}</span>
              </h1>
              <h2 className="text-xl md:text-2xl text-muted-foreground font-light">
                {profile?.title || "Full Stack Developer"}
              </h2>
              <p className="text-lg text-muted-foreground max-w-lg mx-auto md:mx-0 leading-relaxed">
                {profile?.summary || "Building exceptional digital experiences."}
              </p>
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start pt-4">
                ...
                <Button variant="outline" size="lg" className="rounded-full px-8 gap-2" asChild>
                  <a href="#projects">View Work <ArrowDown className="h-4 w-4" /></a>
                </Button>
              </div>
      ...
      <section id="experience" className="py-20 bg-muted/30">
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto mt-12">
            {experience?.sort((a, b) => a.order - b.order).map((job, idx) => (
              <ExperienceItem 
                key={job.id} 
                experience={job} 
                index={idx} 
